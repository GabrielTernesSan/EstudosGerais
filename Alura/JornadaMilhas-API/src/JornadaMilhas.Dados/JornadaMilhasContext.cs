...
public class JornadaMilhasContext : IdentityDbContext
{
    ...
    private string connectionString = "Server=sqlserver,1433;Database=JornadaMilhasV3;User Id=sa;Password=Alura#2024;Encrypt=false;TrustServerCertificate=true;MultipleActiveResultSets=true;";
